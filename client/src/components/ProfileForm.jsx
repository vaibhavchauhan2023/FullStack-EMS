...
const ProfileForm = ({initialData, onSuccess}) => {
  ...
  return (
    <form className='card p-5 sm:p-6 mb-6' onSubmit={handleSubmit}>
        ...
        {error && (
            <div>
                <div className='bg-rose-50 text-rose-700 p-4 rounded-xl text-sm border-rose-200 mb-6 flext items-start gap-3'>
        ...
        {message && (
            <div>
                <div className='bg-emerald-50 text-emerald-700 p-4 rounded-xl text-sm border-emerald-200 mb-6 flext items-start gap-3'>
